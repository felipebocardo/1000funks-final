...
export default function App() {
  // --- CONFIGURAÇÃO ---
  // IMPORTANTE: Para a imagem aparecer, você precisa trocar o link abaixo pelo link da sua foto hospedada.
  ...
  const packages = [
    {
      ...
      oldPrice: "35,00",
      price: "19,90",
      // LINK CORRETO DOS STORIES
      link: "https://wa.me/5514991564081?text=%F0%9F%93%B2Ol%C3%A1!%20vim%20pelo%20instagram%2C%20quero%20contratar%20o%20Storys%2024H%20por%20R%2419%2C90",
    ...
    },
    {
      ...
      oldPrice: "60,00",
      price: "29,90",
      // LINK CORRETO DO FEED
      link: "https://wa.me/5514991564081?text=%F0%9F%93%B2Ol%C3%A1!%20vim%20pelo%20instagram%2C%20quero%20contratar%20o%20Feed%20Timeline%20por%20R%2429%2C90", 
    ...
    },
    {
      ...
      oldPrice: "80,00", 
      price: "44,90",
      // LINK CORRETO DO COMBO (Aqui estava o erro antes)
      link: "https://wa.me/5514991564081?text=%F0%9F%93%B2Ol%C3%A1!%20vim%20pelo%20instagram%2C%20quero%20contratar%20o%20Combo%20Pro%20(feed%20%2B%20storys)%20por%20R%2444%2C90",
      tag: "MAIS VANTAJOSO",
    ...
    <div className="min-h-screen bg-neutral-950 text-white font-sans selection:bg-red-600 selection:text-white pb-12">
      ...
      <header className="pt-12 pb-10 px-4 text-center border-b border-neutral-900 bg-gradient-to-b from-black to-neutral-950">
        <div className="max-w-4xl mx-auto flex flex-col items-center">
          ...
          <div className="mt-6 flex items-center justify-center gap-4 sm:gap-6 text-sm font-medium text-neutral-500">
